...
from torchvision.models.video import mvit_v2_s as _mvit_v2_s
from torchvision.models.video import MViT_V2_S_Weights
from torchvision.models.video.resnet import VideoResNet, R2Plus1dStem, BasicBlock

__all__ = ['r2plus1d_34', 'r2plus1d_18', 'r3d_18', 'mvit_v2_s']
...
def mvit_v2_s(pretrained=True,progress=False, **kwargs):
    if pretrained:
        return _mvit_v2_s(weights=MViT_V2_S_Weights.KINETICS400_V1, progress= progress)

    return _mvit_v2_s(progress= progress)
