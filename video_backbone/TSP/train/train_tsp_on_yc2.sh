...
TRAIN_SUBDIR=../data/yc2/train
VALID_SUBDIR=../data/yc2/valid
TRAIN_CSV_FILENAME=../data/yc2/yc2_train_tsp_groundtruth.csv
VALID_CSV_FILENAME=../data/yc2/yc2_valid_tsp_groundtruth.csv
LABEL_COLUMNS="action-label temporal-region-label"
LABEL_MAPPING_JSONS="../data/yc2/yc2_action_label_mapping.json \
                     ../data/yc2/yc2_temporal_region_label_mapping.json"
LOSS_ALPHAS="1.0 1.0"
