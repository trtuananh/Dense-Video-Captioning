...
def main(args):
    ...
    # valid_augmentations = trans.create_video_transform(
    #     'val', aug_type='augmix', crop_size=112, num_samples=None,
    #     video_mean= (0.43216, 0.394666, 0.37645),
    #     video_std= (0.22803, 0.22145, 0.216989),
    #     min_size= 128,
    #     max_size= 128
    ...
    if args.finetune and model.num_heads == 2:
        print(f'Create a model from pretrained weights')
        pretrained_state_dict = torch.load(args.finetune, map_location='cpu')['model']
